...
@click.option("--class_label", "class_label", type=int, default=1, help="0-indexed class value. Use -1 for a random class and any other class value >= 0 for the other classes. FOr imagenet, the class value range from 0 to 999 and can be found in data/class_information.txt", required=False)
...
# Output parameters
@click.option("--out_imgname", "out_imgname", type=str, default="fig1.png", help="Name of the file to save the output image to.", required=False)
@click.option("--out_gifname", "out_gifname", type=str, default="diffusion1.gif", help="Name of the file to save the output image to.", required=False)
